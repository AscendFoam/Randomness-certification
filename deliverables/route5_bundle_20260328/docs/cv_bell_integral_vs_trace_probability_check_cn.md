...
把 [SDP_solve.tex](../docs/SDP_solve.tex) 里的解析积分公式，与当前代码中通过
...
[SDP_solve.tex](../docs/SDP_solve.tex) 采用的是理想化 CV Bell 测量模型：
...
- route3 的 CV Bell POVM 与概率计算在 [cv_four_phase.py](../src/python/qrng_routes/route3/cv_four_phase.py#L119) 和 [cv_four_phase.py](../src/python/qrng_routes/route3/cv_four_phase.py#L175)
- 分束器与正交相位 POVM 的底层构造在 [common.py](../src/python/qrng_routes/common.py#L194) 、[common.py](../src/python/qrng_routes/common.py#L341) 、[common.py](../src/python/qrng_routes/common.py#L446)
- route5 复用了 route3 的这套概率内核，入口在 [hybrid_iq.py](../src/python/qrng_routes/route5/hybrid_iq.py#L18)
...
- [verify_cv_bell_probabilities.py](../src/python/qrng_routes/verify_cv_bell_probabilities.py)

对应的结果保存在：

- [cv_bell_probability_formula_check.json](../output/qrng_routes/cv_bell_probability_formula_check.json)
...
- 验证脚本：[verify_cv_bell_probabilities.py](../src/python/qrng_routes/verify_cv_bell_probabilities.py)
- 数值结果：[cv_bell_probability_formula_check.json](../output/qrng_routes/cv_bell_probability_formula_check.json)
